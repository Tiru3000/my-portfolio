  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 rounded-full bg-background p-1.5 px-2 shadow-sm border border-foreground/8">
        <ul ref={listRef} className="relative grid grid-cols-3 items-center gap-1">
          {pillRect && (
            <motion.span
              aria-hidden="true"
              initial={false}
            ...
            return (
              ...
              >
                <Link
                  ...
                  className="focus-ring relative flex w-full cursor-pointer items-center justify-center rounded-full px-4 py-1.5 text-sm font-medium transition-colors duration-300"
                >
                  <span
                    className={
                      isActive
